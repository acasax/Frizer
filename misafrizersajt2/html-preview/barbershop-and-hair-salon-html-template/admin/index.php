...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="article" class="nav-link">Početna</a>
      </li>
    </ul>
                  ...
                  <form id="setTermsByDateForm">
                    ...
                    <div class="col-md-12 col-xs-12 col-lg-12 col-sm-12 row">
                      ...
                      <div class="col-md-3 col-sm-6 col-xs-12 col-lg-3">
                        <label for="term_date">Početak</label>
                      ...
                      <div class="terms-by-date-button">
                        <button type="submit" id="confirm_term_by_date" name="confirm_term_by_date" class="btn btn-primary blue_gradient_button">Sačuvaj</button>
                      </div>
                    </div>
                  </form>
  ...
  <footer class="main-footer">
    ...
    <div class="float-right d-none d-sm-inline-block">
      Developed by <a href="https://resivoje.com/">Rešivoje</a>
    </div>
  </footer>
  <!-- Control Sidebar -->
