(function ($) {
    ...
    var $document = $(document),
        ...
        const languages = {
                ...
                'bookingSuccess': 'Uspešno rezervisan termin.',
                'contactWelcome': 'Dobro došli',
                'contactSecMsg': 'hvala na poruci. Uskoro ćemo Vam se javiti.'
            },
            'en': {
            'globalErrorMsg'
        :
        ...
        :
         ...
         'bookingSuccess': 'Successfuly reserved appointment.',
                'contactWelcome': 'Welcome',
                'contactSecMsg': 'thanks for the message. We will contact you shortly.'
        }
    }
                    ...
                    $(form).ajaxSubmit({
                        ...
                        success: function success(data) {
                            ...
                            if(data.type === "message"){
                                str = data;
                                const msg= translate(str.welcome)+" " + str.username +", " +  translate(str.secMsg)
                                swal({
                                    title: "Success",
                                    text: msg,
                                    timer: 2000,
